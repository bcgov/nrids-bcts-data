...
--	LICN.BLAZ_ADMIN_ZONE_ID,
    ...
    -- Assuming CONVERTRound is a rounding function, we use ROUND in PostgreSQL
    ROUND(
        (
            LEAST(CURRENT_DATE, DATE '2025-04-30') - ACTB.DVS_DATE
        )
    ) AS Days_in_DIP,

    CASE
        WHEN ROUND(LEAST(CURRENT_DATE, DATE '2025-04-30') - ACTB.DVS_DATE) < 1 THEN 'Less than One Day'
        WHEN ROUND(LEAST(CURRENT_DATE, DATE '2025-04-30') - ACTB.DVS_DATE) < 181 THEN '1 to 180 Days'
        WHEN ROUND(LEAST(CURRENT_DATE, DATE '2025-04-30') - ACTB.DVS_DATE) < 366 THEN '181 to 365 Days'
        WHEN ROUND(LEAST(CURRENT_DATE, DATE '2025-04-30') - ACTB.DVS_DATE) < 546 THEN '366 to 545 Days'
        WHEN ROUND(LEAST(CURRENT_DATE, DATE '2025-04-30') - ACTB.DVS_DATE) < 731 THEN '546 to 730 Days'
